...
export default function About() {
  ...
  return (
    <div id="about" className={styles.about} ref={sectionRef}>
      <div className="container">

        {/* ── CHAPTER 1: Intro ────────────────────────────────────── */}
        <section className={styles.chapterSection} data-chapter="about-intro">
        ...
        {/* ── CHAPTER 2: Approach ─────────────────────────────────── */}
        <section className={styles.chapterSection} data-chapter="about-approach">
        ...
        {/* ── CHAPTER 3: Process ──────────────────────────────────── */}
        <section className={styles.chapterSection} data-chapter="about-process">
